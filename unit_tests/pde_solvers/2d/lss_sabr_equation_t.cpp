#include "lss_sabr_equation_t.hpp"
...
void impl_sabr_equation_double_sweep_solver_crank_nicolson_stepping()
{
    using lss_pde_solvers::default_heat_solver_configs::host_bwd_dssolver_cn_solver_config_ptr;
...
void test_impl_sabr_equation_double_sweep_solver_stepping()
{
    std::cout << "============================================================\n";
    std::cout << "============== Implicit SABR Equation (Dir BC) =============\n";
    std::cout << "============================================================\n";

    impl_sabr_equation_double_sweep_solver_crank_nicolson_stepping();
