...
void host_sor_bvp_dirichlet_bc_test()
{
    /*
    ...
    */
    ...
    auto dss = std::make_shared<sor_solver>(N);
...
void test_host_sor_bvp_dirichlet_bc()
{
    std::cout << "==================================================\n";
    std::cout << "================ SOR (Dirichlet BC) ==============\n";
    std::cout << "==================================================\n";

    host_sor_bvp_dirichlet_bc_test();

    std::cout << "==================================================\n";
}

void host_sor_bvp_robin_bc_test()
{
...
void test_host_sor_bvp_robin_bc()
{
    std::cout << "==================================================\n";
    std::cout << "================ SOR (Robin BC) ==================\n";
    std::cout << "==================================================\n";

    host_sor_bvp_robin_bc_test();

    std::cout << "==================================================\n";
}

void host_sor_bvp_mix_bc_test()
{
...
void test_host_sor_bvp_mix_bc()
{
    std::cout << "==================================================\n";
    std::cout << "================= SOR (Mix BC) ===================\n";
    std::cout << "==================================================\n";

    host_sor_bvp_mix_bc_test();
