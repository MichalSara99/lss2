#include "lss_thomas_lu_solver_t.hpp"
...
void thomas_lu_bvp_dirichlet_bc_test()
{
    ...
    */
    ...
    auto dss = std::make_shared<thomas_lu_solver>(N);
...
void test_thomas_lu_bvp_dirichlet_bc()
{
    std::cout << "==================================================\n";
    std::cout << "======= Thomas LU Solver (Dirichlet BC) ==========\n";
    std::cout << "==================================================\n";

    thomas_lu_bvp_dirichlet_bc_test();

    std::cout << "==================================================\n";
}

void thomas_lu_bvp_robin_bc_test()
{
...
void test_thomas_lu_bvp_robin_bc()
{
    std::cout << "==================================================\n";
    std::cout << "======= Thomas LU Solver (Robin BC) ==============\n";
    std::cout << "==================================================\n";

    thomas_lu_bvp_robin_bc_test();

    std::cout << "==================================================\n";
}

void thomas_lu_bvp_mix_bc_test()
{
...
void test_thomas_lu_bvp_mix_bc()
{
    std::cout << "==================================================\n";
    std::cout << "========= Thomas LU Solver (Mix BC) ==============\n";
    std::cout << "==================================================\n";

    thomas_lu_bvp_mix_bc_test();
