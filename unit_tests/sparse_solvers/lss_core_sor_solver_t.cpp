#include "lss_core_sor_solver_t.hpp"

#include "../../sparse_solvers/core/sor_solver/lss_core_sor_solver.hpp"
#include <iostream>
#include <string>
...
void host_sor_solver_basic_test()
{
...
void test_host_sor_solver_basic()
{
    std::cout << "============================================================\n";
    std::cout << "=============== Initialise Flat-Raw-Matrix =================\n";
    std::cout << "============================================================\n";

    host_sor_solver_basic_test();

    std::cout << "============================================================\n";
}

void host_sor_solver_ode_test()
{
...
void test_host_sor_solver_ode()
{
    std::cout << "============================================================\n";
    std::cout << "=========================== BVP ============================\n";
    std::cout << "============================================================\n";

    host_sor_solver_ode_test();
