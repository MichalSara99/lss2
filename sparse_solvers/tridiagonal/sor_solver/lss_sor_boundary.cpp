...
const triplet_t sor_boundary::init_coefficients(boundary_2d_pair const &boundary, double time, double space_arg)
{
    initialise(boundary, time, space_arg);
    return std::make_tuple(b_init_, c_init_, f_init_);
}

const triplet_t sor_boundary::init_coefficients(boundary_3d_pair const &boundary, double time, double space_1_arg,
                                                double space_2_arg)
{
...
const triplet_t sor_boundary::final_coefficients(boundary_2d_pair const &boundary, double time, double space_arg)
{
    finalise(boundary, time, space_arg);
    return std::make_tuple(a_end_, b_end_, f_end_);
}

const triplet_t sor_boundary::final_coefficients(boundary_3d_pair const &boundary, double time, double space_1_arg,
                                                 double space_2_arg)
{
...
void sor_boundary::initialise(boundary_2d_pair const &boundary, double time, double space_arg)
{
    const auto a_0 = std::get<0>(lowest_quad_);
    const auto b_0 = std::get<1>(lowest_quad_);
    const auto c_0 = std::get<2>(lowest_quad_);
...
void sor_boundary::initialise(boundary_3d_pair const &boundary, double time, double space_1_arg, double space_2_arg)
{
    const auto a_0 = std::get<0>(lowest_quad_);
    const auto b_0 = std::get<1>(lowest_quad_);
    const auto c_0 = std::get<2>(lowest_quad_);
...
void sor_boundary::finalise(boundary_2d_pair const &boundary, double time, double space_arg)
{
    const auto a = std::get<0>(higher_quad_);
    const auto b = std::get<1>(higher_quad_);
    const auto c = std::get<2>(higher_quad_);
...
void sor_boundary::finalise(boundary_3d_pair const &boundary, double time, double space_1_arg, double space_2_arg)
{
    const auto a = std::get<0>(higher_quad_);
    const auto b = std::get<1>(higher_quad_);
    const auto c = std::get<2>(higher_quad_);
...
const double sor_boundary::upper_boundary(boundary_2d_pair const &boundary, double time, double space_arg)
{
    double ret{};
...
const double sor_boundary::upper_boundary(boundary_3d_pair const &boundary, double time, double space_1_arg,
                                          double space_2_arg)
{
    double ret{};
...
const double sor_boundary::lower_boundary(boundary_2d_pair const &boundary, double time, double space_arg)
{
    double ret{};
...
const double sor_boundary::lower_boundary(boundary_3d_pair const &boundary, double time, double space_1_arg,
                                          double space_2_arg)
{
    double ret{};
