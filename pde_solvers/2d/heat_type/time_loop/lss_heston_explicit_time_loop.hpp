#if !defined(_LSS_HESTON_EXPLICIT_TIME_LOOP_HPP_)
#define _LSS_HESTON_EXPLICIT_TIME_LOOP_HPP_
...
/**
 * heston_explicit_time_loop object
 */
class heston_explicit_time_loop
{

  public:
    static void run(heston_explicit_solver_method_ptr const &solver_ptr,
...
#endif //_LSS_HESTON_EXPLICIT_TIME_LOOP_HPP_
