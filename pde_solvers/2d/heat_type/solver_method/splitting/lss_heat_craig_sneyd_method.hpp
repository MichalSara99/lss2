/**
    ...
    @file      lss_heat_craig_sneyd_method.hpp
    @brief     Craig-Sneyd splitting
    @details   ~
    @author    Michal Sara
    @date      14.02.2022
...
class craig_sneyd_rhs
{
  ...
  public:
    ...
    static void rhs_final(heat_coefficients_2d_ptr const &cfs, grid_config_2d_ptr const &grid_cfg,
                          std::size_t const &x_index, double const &x, matrix_2d const &input,
                          matrix_2d const &inhom_input, double const &time, container_t &solution);
};
 ...
 */
class heat_craig_sneyd_method : public heat_splitting_method
{
  ...
  public:
    explicit heat_craig_sneyd_method(lss_tridiagonal_solver::tridiagonal_solver_ptr const &solvery_ptr,
                                     lss_tridiagonal_solver::tridiagonal_solver_ptr const &solveru_ptr,
                                     heat_coefficients_2d_ptr const &coefficients, grid_config_2d_ptr const grid_config,
