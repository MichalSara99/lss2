...
void douglas_rachford_rhs::rhs_intermed_1(heat_coefficients_2d_ptr const &cfs, grid_config_2d_ptr const &grid_cfg,
...
void douglas_rachford_rhs::rhs_intermed_1_source(heat_coefficients_2d_ptr const &cfs,
                                                 grid_config_2d_ptr const &grid_cfg, std::size_t const &y_index,
                                                 double const &y, matrix_2d const &input, matrix_2d const &inhom_input,
                                                 matrix_2d const &inhom_input_next, double const &time,
...
void douglas_rachford_rhs::rhs(heat_coefficients_2d_ptr const &cfs, grid_config_2d_ptr const &grid_cfg,
...
void heat_douglas_rachford_method::solve(matrix_2d const &prev_solution,
                                         ...
                                         matrix_2d &solution)
{
    ...
    matrix_2d inter_solution(coefficients_->space_size_x_, coefficients_->space_size_y_, double{});
    ...
    for (std::size_t j = 1; j < coefficients_->space_size_y_ - 1; ++j)
    {
        ...
        douglas_rachford_rhs::rhs_intermed_1(coefficients_, grid_cfg_, j, y, prev_solution, time, rhs_);
        ...
        inter_solution.column(j) = solution_v;
    }
    ...
    for (std::size_t i = 1; i < coefficients_->space_size_x_ - 1; ++i)
    {
        ...
        douglas_rachford_rhs::rhs(coefficients_, grid_cfg_, i, x, prev_solution, inter_solution, time, rhs_);
