...
void hhw_equation::solve(matrix_3d &solution)
{
    ...
    matrix_3d prev_sol(space_size_x, space_size_y, space_size_z, double{});
    // create container to carry next solution:
    matrix_3d next_sol(space_size_x, space_size_y, space_size_z, double{});
