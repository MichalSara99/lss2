...
void explicit_hhw_boundary_rhs::rhs(heat_coefficients_3d_ptr const &cfg, grid_config_3d_ptr const &grid_cfg,
...
void explicit_hhw_boundary_rhs::rhs_source(heat_coefficients_3d_ptr const &cfg, grid_config_3d_ptr const &grid_cfg,
                                           std::size_t const &y_index, double const &y,
...
hhw_explicit_boundary_solver::hhw_explicit_boundary_solver(heat_coefficients_3d_ptr const &coefficients,
...
void hhw_explicit_boundary_solver::solve(matrix_3d const &prev_solution, boundary_3d_pair const &x_boundary_pair,
                                         ...
                                         matrix_3d &solution)
{
    ...
    matrix_2d solution_v(coefficients_->space_size_x_, coefficients_->space_size_z_, double{});
    /// get the right-hand side of the scheme:
    auto const y = grid_3d::value_2(grid_cfg_, 0);
    explicit_hhw_boundary_rhs::rhs(coefficients_, grid_cfg_, 0, y, x_boundary_pair, z_boundary_pair, prev_solution,
                                   time, solution_v);
    // boundary plane at Y = 0:
    solution.column_plane(0) = solution_v.data();
    ...
    solution.column_plane(coefficients_->space_size_y_ - 1) = solution_v.data();
}
